...
<div class="max-w-[1500px] mx-auto space-y-7">
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        @if($canCreateKnowledge)<a href="{{ route('knowledge.penyakit.create') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-[#176b45] px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#115a39] transition"><span class="text-lg leading-none">+</span> {{ $createLabel }}</a>@endif
    </div>
